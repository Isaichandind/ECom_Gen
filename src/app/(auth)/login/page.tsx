  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-8 bg-foreground/5">
      <div className="w-full max-w-md p-8 bg-card rounded-2xl shadow-sm border border-border">
        <h1 className="text-3xl font-black text-center mb-2 text-foreground">Welcome Back</h1>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-foreground text-background py-4 rounded-xl font-bold text-lg hover:bg-gray-800 disabled:opacity-50 transition-colors mt-4"
          >
