    ...
    <div className="min-h-screen flex flex-col bg-[#f9f9f9]">
      ...
      <div className="bg-[#111111] text-white">
        <div className="max-w-[1400px] mx-auto px-6 py-24 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-md mx-auto">Get early access to new product drops, exclusive wellness guides, and member-only pricing.</p>
          ...
          <p className="text-[10px] text-gray-500 tracking-wider uppercase mt-4">NO SPAM. JUST WELLNESS. UNSUBSCRIBE AT ANY TIME.</p>
        </div>
      </div>
      ...
      <footer className="bg-white border-t border-gray-200 py-8">
        <div className="max-w-[1400px] mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-gray-500 text-sm font-medium">
            ...
            <a href="#" className="hover:text-gray-900 transition-colors">Refunds</a>
        ...
        <div className="max-w-[1400px] mx-auto px-6 mt-2">
          <p className="text-[10px] text-gray-400 font-medium uppercase tracking-wider">&copy; {new Date().getFullYear()} VITALITY POWDERS INC. ALL RIGHTS RESERVED.</p>
        </div>
      </footer>
    </div>
  );
